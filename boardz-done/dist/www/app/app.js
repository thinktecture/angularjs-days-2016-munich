System.register(['angular2/core', 'angular2/router', './components/login/login', './components/dashboard/dashboard', './components/sidebar/sidebar', './components/header/header', './components/games/games', './components/notifications/notifications', './services/all', './components/radiussearch/radiussearch', './services/log.service', './models/loglevel', './services/signalr.service', './services/login.service', './services/notification.service', './services/ui.notification.service', "./services/nativeIntegrationService"], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, login_1, dashboard_1, sidebar_1, header_1, games_1, notifications_1, all_1, radiussearch_1, log_service_1, loglevel_1, signalr_service_1, login_service_1, notification_service_1, ui_notification_service_1, nativeIntegrationService_1;
    var BoardzApp;
    return {
        setters:[
            function (core_1_1) {
            ...
            function (nativeIntegrationService_1_1) {
                nativeIntegrationService_1 = nativeIntegrationService_1_1;
            }],
        execute: function() {
            BoardzApp = (function () {
                function BoardzApp(_signalRService, _loginService, _notificationService, _nativeIntegrationService, _uiNotificationService, _logService) {
                    this._signalRService = _signalRService;
                    this._loginService = _loginService;
                    this._notificationService = _notificationService;
                    this._nativeIntegrationService = _nativeIntegrationService;
                ...
                BoardzApp = __decorate([
                    ...
                    __metadata('design:paramtypes', [signalr_service_1.SignalRService, login_service_1.LoginService, notification_service_1.NotificationService, nativeIntegrationService_1.NativeIntegrationService, ui_notification_service_1.UiNotificationService, log_service_1.LogService])
                ], BoardzApp);
                return BoardzApp;
            }());
